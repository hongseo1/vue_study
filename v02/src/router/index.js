...
const page_titles = {
  '01': 'text interpolation(삽입, 보간법) & Directive(지시, 지령) 방법',
  '02': 'Directive v-if, else-if, v-for',
  '03': 'v-on 이벤트 핸들링',
  '04': 'methods 옵션, 사용자 함수 / 메서드 만들기',
  '05': 'v-on modifier 수정자',
  '06': '마우스 좌표 출력하기',
  '07': '양방향 바인딩 v-model 디렉티브',
  '08': 'Dom 요소의 속성을 동적으로 변경하는 v-bind 디렉티브',
  '09': 'Class 바인딩',
  '10': 'Style 바인딩',
  '11': 'Computed 계산된 속성',
  '12': 'watcher 속성',
  '13': 'Component 지역 컴포넌트와 전역 컴포넌트',
  '14': '컴포넌트 생명주기(component Lifecycle)',
  '15': 'ref 속성',
  // 필요한 만큼 페이지 제목을 추가
};
const routes = [
